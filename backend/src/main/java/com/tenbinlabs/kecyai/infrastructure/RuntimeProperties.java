 ...
 *   RUNTIME_AUTOSTART_ENABLED          → runtime.autostart.enabled
 *   RUNTIME_AUTOSTART_TIMEOUT_SECONDS  → runtime.autostart.timeout-seconds
 *   RUNTIME_AUTOSTART_CONTAINER_NAME   → runtime.autostart.container-name
 */
@Getter
@Setter
